-- Branda Platform — Public content, contacts, careers and representative referrals
-- Version: 008
-- Run after 007_branda_platform_plans_description_fix.sql
...
INSERT INTO public.platform_home_settings (
  ...
  'برندة تساعد العلامة التجارية في إدارة المنيو التفاعلي - نظام الحجوزات والطلبات - نظام العروض والخصومات - متابعة العملاء - بطاقات الولاء - وتقديم تقارير فورية وشاملة من لوحة تحكم واحدة',
  ...
  'انضم الآن وابدأ رحلتك مع برندة — ابن منصتك التقنية وهويتك الرقمية في منصة واحدة',
  'برندة منصة تقنية تساعد العلامات التجارية في قطاع الضيافة على بناء حضور رقمي متكامل وإدارة تجربة العميل',
  'أن تصبح برندة الشريك التقني الأول للعلامات التجارية الطموحة في قطاع الضيافة',
