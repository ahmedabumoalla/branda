# Supabase Migrations Tests Source
...
# Local + Staging test seed only — NEVER enable on Production.
[db.seed]
enabled = false
sql_paths = ["./seed/security_test_seed.sql"]
...
# File: supabase/tests/001_rls_isolation_test.sql
...
# File: supabase/tests/002_orders_security_test.sql
...
# File: supabase/tests/003_reservations_experience_test.sql
...
# File: supabase/tests/004_notifications_loyalty_test.sql
...
# File: supabase/tests/005_storage_policy_test.sql
...
# File: supabase/tests/006_public_data_exposure_test.sql
...
# File: supabase/tests/007_security_closure_test.sql
