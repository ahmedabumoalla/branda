...
arenaImage.src = '/battle-arena/mythic-rift/assets/generated/arena-desert-crystal.png';
...
async function loadMap() {
  const csv = await fetch('/battle-arena/mythic-rift/data/tilemap.csv').then(r => r.text());
...
const query = new URLSearchParams(window.parent === window ? location.search : window.parent.location.search);
