  ...
  return (
    <main dir="rtl" className="flex min-h-screen items-center justify-center bg-[#F8F4EF] px-4">
      <section className="w-full max-w-md rounded-[32px] bg-white p-8 shadow-xl">
        <p className="font-black text-[#6B3A25]">برندكسا تشغيل</p>
        <h1 className="mt-2 text-3xl font-black text-[#311912]">تسجيل دخول نقطة التشغيل</h1>
        <div className="mt-6 space-y-4">
          <input className="w-full rounded-2xl bg-[#F8F4EF] px-4 py-4 font-bold text-[#311912]" placeholder="بريد موظف التشغيل" value={email} onChange={(e) => setEmail(e.target.value)} />
          <div className="relative">
            <input className="w-full rounded-2xl bg-[#F8F4EF] px-4 py-4 pl-12 font-bold text-[#311912]" placeholder="كلمة مرور موظف التشغيل" type={show ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)} />
