      ...
      <section className="flex min-w-0 items-start justify-center bg-white px-4 py-8 sm:px-6 sm:py-10">
        <div className="w-full max-w-[760px]">
          ...
          <form className="space-y-5" onSubmit={submit}>
            ...
            <Field label="الرابط المختصر بالإنجليزي"><input value={slug} onChange={(e) => setSlug(e.target.value.toLowerCase().replace(/\s+/g, "-"))} dir="ltr" required className={`${fieldClass} text-left`} style={{ borderColor: C.borderSand, background: C.creamBase }} /></Field>
