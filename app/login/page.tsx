  ...
  return (
    <main dir="rtl" className="min-h-screen bg-[#F8F4EF] text-[#2B1710]">
      <section className="mx-auto grid min-h-screen max-w-6xl items-center gap-10 px-6 py-10 lg:grid-cols-2">
        <div className="relative overflow-hidden rounded-[40px] border border-[#E5D8CD] bg-gradient-to-br from-[#3A2117] to-[#241610] p-10 text-[#F8F4EF] shadow-2xl">
          <Image
            src={LOGO.brownBg}
            alt=""
            width={200}
          ...
          <h1 className="relative mt-8 text-5xl font-black leading-tight">دخول لوحة التحكم</h1>
        ...
        <SoftCard className="p-8">
          ...
          <h2 className="text-3xl font-black text-[#3A2117]">تسجيل الدخول</h2>
