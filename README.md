...
- `VERCEL_DOMAIN_PURCHASE_LIVE=false` يعني Mock checkout بدون شراء فعلي.
- تفعيل الشراء الحقيقي يتطلب ضبط `VERCEL_DOMAIN_PURCHASE_LIVE=true` بعد التأكد من الدفع.
